...
- Name: rightSidebar.spec.ts >> Right sidebar tests in small screen size (overlay mode) >> clicking drawer links opens right sidebar and updates URL (overlay mode)
- Location: src/tests/rightSidebar.spec.ts:39:3
