...
- Name: rightSidebar.spec.ts >> Right sidebar tests in full screen size (wide mode) >> right sidebar width can be resized with the drag handle (wide mode)
- Location: src/tests/rightSidebar.spec.ts:341:3
