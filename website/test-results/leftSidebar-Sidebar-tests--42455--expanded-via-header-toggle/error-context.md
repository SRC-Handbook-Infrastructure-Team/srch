...
- Name: leftSidebar.spec.ts >> Sidebar tests in full screen size (wide mode) >> sidebar can be collapsed and expanded via header toggle
- Location: src/tests/leftSidebar.spec.ts:267:3
...
Call log:
  - waiting for locator('button.header-toggle')
    - locator resolved to <button class="header-toggle" title="Expand sidebar" aria-label="Expand sidebar">…</button>
