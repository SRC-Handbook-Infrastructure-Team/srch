...
- Name: rightSidebar.spec.ts >> Right sidebar tests in full screen size (wide mode) >> opening a drawer link preserves main content scroll position after wide-mode transition
- Location: src/tests/rightSidebar.spec.ts:264:3
