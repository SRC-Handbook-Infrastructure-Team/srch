...
- Name: leftSidebar.spec.ts >> Sidebar tests in small screen size (overlay mode) >> navigates between subsections and sections using the left sidebar
- Location: src/tests/leftSidebar.spec.ts:31:3
...
Call log:
  - waiting for locator('aside.left-sidebar .sidebar-section-header') to be visible
