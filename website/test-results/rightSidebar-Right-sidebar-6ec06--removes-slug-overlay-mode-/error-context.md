...
- Name: rightSidebar.spec.ts >> Right sidebar tests in small screen size (overlay mode) >> closing via "X" or re-clicking the term closes right sidebar and removes slug (overlay mode)
- Location: src/tests/rightSidebar.spec.ts:68:3
