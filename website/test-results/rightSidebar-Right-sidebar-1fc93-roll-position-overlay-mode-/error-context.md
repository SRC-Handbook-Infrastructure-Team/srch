...
- Name: rightSidebar.spec.ts >> Right sidebar tests in small screen size (overlay mode) >> opening a drawer link preserves main content scroll position (overlay mode)
- Location: src/tests/rightSidebar.spec.ts:200:3
