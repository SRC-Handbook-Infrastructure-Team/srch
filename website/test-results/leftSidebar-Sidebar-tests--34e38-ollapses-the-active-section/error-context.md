...
- Name: leftSidebar.spec.ts >> Sidebar tests in small screen size (overlay mode) >> "Collapse all" never collapses the active section
- Location: src/tests/leftSidebar.spec.ts:113:3
