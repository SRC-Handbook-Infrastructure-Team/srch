...
- Name: rightSidebar.spec.ts >> Right sidebar tests in small screen size (overlay mode) >> in overlay mode, opening the right sidebar does not change main margins
- Location: src/tests/rightSidebar.spec.ts:174:3
