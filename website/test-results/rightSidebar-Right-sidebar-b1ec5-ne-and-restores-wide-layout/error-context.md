...
- Name: rightSidebar.spec.ts >> Right sidebar tests in full screen size (wide mode) >> resizing between wide and overlay modes keeps drawer behavior sane and restores wide layout
- Location: src/tests/rightSidebar.spec.ts:401:3
