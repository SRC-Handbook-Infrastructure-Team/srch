...
- Name: rightSidebar.spec.ts >> Right sidebar tests in full screen size (wide mode) >> navigating to a different section/subsection auto-closes the right sidebar (wide mode)
- Location: src/tests/rightSidebar.spec.ts:378:3
