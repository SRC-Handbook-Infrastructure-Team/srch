...
- Name: leftSidebar.spec.ts >> Sidebar tests in full screen size (wide mode) >> expand and collapse all button toggles all sections in wide mode
- Location: src/tests/leftSidebar.spec.ts:244:3
