...
- Name: rightSidebar.spec.ts >> Right sidebar tests in small screen size (overlay mode) >> opening a second drawer term updates active chip and keeps sidebar open (overlay mode)
- Location: src/tests/rightSidebar.spec.ts:145:3
