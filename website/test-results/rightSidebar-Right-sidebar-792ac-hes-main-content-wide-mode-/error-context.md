...
- Name: rightSidebar.spec.ts >> Right sidebar tests in full screen size (wide mode) >> clicking drawer links opens right sidebar and pushes main content (wide mode)
- Location: src/tests/rightSidebar.spec.ts:231:3
