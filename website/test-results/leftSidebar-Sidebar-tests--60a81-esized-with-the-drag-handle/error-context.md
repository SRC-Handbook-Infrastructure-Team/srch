...
- Name: leftSidebar.spec.ts >> Sidebar tests in full screen size (wide mode) >> sidebar width can be resized with the drag handle
- Location: src/tests/leftSidebar.spec.ts:292:3

# Error details

```
Error: Sidebar bounding box after resize not available
```
